...
一个面向 RunningHub 海外站的 Windows 桌面客户端，用来管理多个工作流、账号和生成任务。当前版本：**v0.1.6**。
...
2. 下载 `RunningHub-Runner-v0.1.6-windows-x64.zip`。
...
```text
release-build/RunningHub-Runner-v0.1.6-windows-x64.zip
```
